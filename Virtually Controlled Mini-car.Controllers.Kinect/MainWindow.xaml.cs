...
namespace CakeRobot.Controllers.Kinect
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private VirtuallyControlledMinicar.Controllers.Kinect.ConnectionHelper _helper = new VirtuallyControlledMinicar.Controllers.Kinect.ConnectionHelper();
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (null == this._sensor)
            {
                this.statusBarText.Text = VirtuallyControlledMinicar.Controllers.Kinect.Properties.Resources.NoKinectReady;
            }
